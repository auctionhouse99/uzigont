...
const houses = [
  {
    ...
    price: 'от 15 000 000 ₽', area: 90, beds: 2, baths: 2, folder: 3,
    gallery: ['project3-1','project3-2','project3-3','project3-4','plan3-1'],
    specs: [
      ['Площадь дома', '90 м²'], ['Кухня-гостиная', '31,3 м²'],
      ['Спальни', '2'], ['Санузлы', '2'], ['Терраса', '14,4 + 20,0 м²'],
      ['Фундамент', 'монолитная плита'], ['Стены', 'газобетон 250 мм + утепление 80 мм'],
      ['Фасады', 'монолит + покраска'], ['Крыша', 'плоская, утеплённая, ПВХ-мембрана'],
    ],
  },
  {
    name: 'U120', type: 'Одноэтажный дом', floors: '1 этаж',
    price: 'от 17 900 000 ₽', area: 120, beds: 2, baths: 1, folder: 4,
    gallery: ['project4-1','project4-2','project4-3','project4-4','plan4-1'],
    specs: [
      ['Площадь дома', '120 м²'], ['Кухня-гостиная', '31,9 м²'],
...
const TOP = 13, W = 60, H = 76, gapX = 11.5;
for (let i = 1; i <= 25; i++){
  const top = i <= TOP;
  const col = top ? (i - 1) : (i - TOP - 1);
  const colsInRow = top ? TOP : 25 - TOP;
  const x = 55 + col * (W + gapX);
  const y = top ? 50 : 296;
